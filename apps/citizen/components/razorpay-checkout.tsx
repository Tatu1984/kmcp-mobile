...
const styles = StyleSheet.create({
  ...
  title: { ...theme.text.title, color: theme.colour.ink, flexShrink: 1 },
  close: {
  ...
  closePressed: { backgroundColor: theme.colour.raise },
  closeGlyph: { fontSize: 20, color: theme.colour.ink },
  webview: { flex: 1 },
});
